...
$list_query="select *from register";
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Register Table</h6>
                            <table class="table"> 
                        <thead>
                                    <tr>
                                        <!-- <th scope="col">#</th>
...
?>
		<tr>
			...
			<td><a href="admin_delete.php?delete_id=<?php echo $list_data['id']; ?>">DELETE</a></td>
			<!-- <td><a href=".php?update_id=<?php echo $list_data['id']; ?>">UPDATE</a></td> -->
		</tr>
		<?php }?>
                                </thead>
