...
$res=mysqli_query($con,"SELECT * FROM register WHERE doctorId=".$usersession);
...
//INSERT
$query = " INSERT INTO ourschedule (  scheduleDate, scheduleDay, startTime, endTime,  bookAvail)
