<?php 
$mainurl="http://localhost/culture_mvc1/admin_cul/";
$baseurl="http://localhost/culture_mvc1/admin_cul/assets/";
...
<head>
    <meta charset="utf-8">
    <title>Culture Art admin | Dashboard</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="" name="keywords">
    <meta content="" name="description">

    <!-- Favicon -->
    <link href="<?php echo $baseurl;?>img/favicon.ico" rel="icon">
    ...
    <div class="navbar-nav align-items-center ms-auto">
        ...
        <div class="nav-item dropdown">
            ...
            <img class="rounded-circle" src="<?php echo $baseurl;?>img/k.jpg" alt="" style="width: 40px; height: 40px;">
                <span class="d-none d-lg-inline-flex">Krupanshi</span>
            </a>
            <div class="dropdown-menu dropdown-menu-end bg-secondary border-0 rounded-0 rounded-bottom m-0">
             
                <a href="<?php echo $mainurl;?>?logout-here" class="dropdown-item" onclick="return confirm('are you sure to Logout here')">Log Out</a>
            </div>
        </div>
    </div>
</nav>
