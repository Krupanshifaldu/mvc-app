...
<td><a href="<?php echo $mainurl;?>admin-addsubcategory?delete-subcategory=<?php echo base64_encode($row["subcatid"]);?>" class="btn btn-danger btn-sm" onclick="return confirm('are you sure to delete subcategory ?')"><i class="bi bi-trash"></i></a> | <a href="<?php echo $mainurl;?>update_subcategory" class="btn btn-info btn-sm"><i class="bi bi-pencil"></i></a> </td>
</tr>
<?php 
}
?>
