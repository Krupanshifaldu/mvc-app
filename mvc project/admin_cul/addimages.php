...
<button type="submit" name="add" class="btn btn-primary">Add Images</button>
</form>
</div>
</div>
...
<div class="bg-secondary rounded h-100 p-4">
<h6 class="mb-4">Manage All Images</h6>
<table class="table">
<thead>
<tr>
<th scope="col">#Id</th>
...
?>
<tr>
<th scope="row"><?php echo $row["iid"];?></th>
<td><?php echo $row["categoryname"];?></td>
<td><?php echo $row["subcategoryname"];?></td>
<td><?php echo $row["iname"];?></td>
<td><img src="<?php echo $row["img"];?>" class="img-fluid" width="85px" height="85px"></td>
<td><?php echo $row["des"];?></td>
<td><a href="<?php echo $mainurl;?>images?img=<?php echo base64_encode($row["iid"]);?>" class="btn btn-danger btn-sm" onclick="return confirm('are you sure to delete subcategory ?')"><i class="bi bi-trash"></i></a> | <a href="<?php echo $mainurl;?>update_img" class="btn btn-info btn-sm"><i class="bi bi-pencil"></i></a> </td>
</tr>
<?php 
}
?>
